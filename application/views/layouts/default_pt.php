    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          ...
          <a class="brand" href="../bem_vindo">Ecua Henivad</a>
           <div class="btn-group pull-right">
            <a class="btn dropdown-toggle" data-toggle="dropdown" href="#">
              <i class="icon-globe"></i> Português
              <span class="caret"></span>
            </a>
            <ul class="dropdown-menu">
              <li><a href="../bienvenido">Español</a></li>
              <li class="divider"></li>
          ...
          <div class="nav-collapse">
            <ul class="nav">
              <li><a href="../work_pt">Nosso Trabalho</a></li>
              <li><a href="../maps_pt">Mapas</a></li>
              <li><a href="../about_pt">About</a></li>
              <li><a href="../contacts_pt">Contacte-nos</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
